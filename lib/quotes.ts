...
import { addCategoriesToQuotes } from "@/data/quotes-with-categories"
...
// Load quotes from JSON file and add categories
export const quotes: Quote[] = addCategoriesToQuotes(quotesData)
